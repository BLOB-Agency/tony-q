...
export default function Contact() {
  return (
    <main className="flex min-h-screen flex-col gap-[48px] items-center sm:items-start lg:ml-[360px] mt-[48px] ">
        ...
        <a href="" target="_blank" className=" flex items-center justify-center border-[1.5px] border-black rounded-full w-[75px] h-[75px] transition-all duration-300 hover:scale-110 ease-in-out active:scale-90">
            <Image src="/images/icons/icon-linkedin.svg" width={35} height={35} alt="icon Behance" />
        </a>
        <a href="" target="_blank" className=" flex items-center justify-center border-[1.5px] border-black rounded-full w-[75px] h-[75px] transition-all duration-300 hover:scale-110 ease-in-out active:scale-90 ">
            <Image src="/images/icons/icon-insta.svg" width={35} height={35} alt="icon Behance" />
        </a>
        <a href="" target="_blank" className=" flex items-center justify-center border-[1.5px] border-black rounded-full w-[75px] h-[75px] transition-all duration-300 hover:scale-110 ease-in-out active:scale-90 ">
